...
public class EntityTests {
	...
	public void getAndSetName() {
		...
		testUser.setName("raji");
		assertEquals(testUser.getName(),"raji");
	}
	...
	public void getAndSetEmail() {
		...
		testUser.setEmail("raji@email.com");
		assertEquals(testUser.getEmail(),"raji@email.com");
	}
	...
	public void checkConstructor() {
		User testUser = new User("raji","raji@email.com","123");
		
		User checkUser = new User();
		checkUser.setName("raji");
		checkUser.setEmail("raji@email.com");
